...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        aboutMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(Main.this,
                        "This Dictionary App V1.0 Developed by AAU Cs Section 1 Group 7 Students\nContact us: group1@aau.edu.et",
                        "About",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        ImageIcon removeFavoriteIcon = new ImageIcon(
                new ImageIcon("trash.png").getImage().getScaledInstance(24, 24, Image.SCALE_SMOOTH));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedWord != null && !selectedWord.trim().isEmpty()) {
                    if (favoriteWords.contains(selectedWord)) {
                        ...
                        JOptionPane.showMessageDialog(Main.this, " This word is not in favorites.", "Error",
                                JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(Main.this, "Please select a word to remove from favorites.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        });
